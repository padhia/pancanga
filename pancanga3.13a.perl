...
#        ($samkranti_year, $samkranti_month, $samkranti_day) = &JulianDay_to_ModernDate(&Ahargana_to_JulianDay($samkranti)); #20010310
        ($samkranti_year, $samkranti_month, $samkranti_day) = &JulianDay_to_ModernDate(&Ahargana_to_JulianDay($samkranti + 0.5)); #20140223 cf. try_calculations
...
print "   ********* Pancanga vers.3.13 **********   M. YANO and M. FUSHIMI \n";#20140223
#print "   ----------------- perl version ------------- March 2002          \n";
print "   ----------------- perl version ------------- February 2004       \n";
print "       This program is based on the Suryasiddhanta.   The constants \n";
print "   of the text were modified  around AD 1000 by the elements called \n";
print "   bija. You can choose with or without bija by entering <B> in <S>.\n";
print "   <MENUES>                                                         \n";
...
print "       because of adhimasa.) You should confirm it by menu <L>.     \n";
print "   <L>:   To find the Indian date (in amanta) from the given modern \n";
...
print "   NOTICE ... Remember the difference of amanta and purnimanta.     \n";
...
print "         M.YANO (for Indian astronomy): yanom\@cc.kyoto-su.ac.jp    \n";
print "         M.FUSHIMI (for programming): fushimi\@fas.harvard.edu      \n";
}
